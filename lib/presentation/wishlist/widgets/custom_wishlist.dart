              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(children: [
                    ...
                    Expanded(child: Text(isArabic(context) ? "  ${wishListEntity.phoneNumber} ${wishListEntity.dialCode?.replaceFirst("+", "")}+" : "  ${wishListEntity.dialCode} ${wishListEntity.phoneNumber}" ,  style: Theme.of(context).textTheme.bodyMedium?.copyWith(fontSize: 12.0))),
                  ]),
                  Row(children: [
