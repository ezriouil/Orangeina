                    ...
                    children: [
                      ...
                      if(state.isVendor!) CustomSettingTile(
                          ...
                          trailing: Switch(
                              ...
                              onChanged: (bool value){ context.read<SettingsCubit>().updateVendorStatus(value, context); })
                      ),
                      ...
                      // - - - - - - - - - - - - - - - - - - ABOUT - - - - - - - - - - - - - - - - - -  //
                      CustomSettingTile(
                          title: CustomLocale.SETTINGS_SIGN_OUT_TITLE.getString(context),
                          subTitle: CustomLocale.SETTINGS_SIGN_OUT_SUB_TITLE.getString(context),
                          icon: Iconsax.close_circle,
                          trailing: Icon(isArabic(context) ? Iconsax.arrow_left_24: Iconsax.arrow_right_3, color: darkLightColor(context)), onClick: (){ context.read<SettingsCubit>().signOut(context: context); }
                      ),
