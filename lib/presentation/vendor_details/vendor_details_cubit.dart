                          ...
                          builder: (context, state) {
                            return DropdownButton<String>(
                                ...
                                onChanged: (String? value) {
                                  emit(state.copyWith(reportReason: value));
                                  currentState = currentState.copyWith(reportReason: value);
                                },
                                icon: WidgetAnimator(atRestEffect: WidgetRestingEffects.wave(), child: const Icon(Iconsax.arrow_circle_down, size: 22.0)
                                ),
